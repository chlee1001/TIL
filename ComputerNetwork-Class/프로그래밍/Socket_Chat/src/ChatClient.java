...
public class ChatClient {
	...
	JButton buttonWhis = (new JButton("Whisper"));
	JButton buttonUsers = (new JButton("Online Users"));
	...
	public ChatClient() {
		...
		buttonPane.add(buttonUsers);
		buttonPane.add(buttonWhis);
		...
		// show Online user button
		// If click the Online Users button, textFiled is set the
		// command(!online)
		buttonUsers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textField.setText("!online");

			}
		});

		// whisper button
		// If click the whisper button, textFiled is set the whisper command
		// format
		buttonWhis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textField.setText("/w [receiver] [message]");
			}
		});

		// clear button
		// If click the clear button, messageArea is cleared
		...
		// Exit button
		// If click the Exit button, It show the confirm dialog Yes or No
		buttonExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int exitValue = JOptionPane.showConfirmDialog(frame, "Do you want to close your client?");
				if (exitValue == 0) {
					System.exit(0);
				} else
					;
